...
DROP SEQUENCE SEQ_MAIN_NO; -- QNA 테이블
...
CREATE SEQUENCE SEQ_MAIN_NO NOCYCLE NOCACHE; -- QNA 시퀀스
-- ----------------------------------------------------
-- 외래키
-- ----------------------------------------------------
-- QNA 외래키
...
-- BOARD 외래키
ALTER TABLE BOARD 
ADD CONSTRAINT FK_BOARD_STATION
FOREIGN KEY(STATION_NO) REFERENCES STATION(STATION_NO);
...
-- BOARD
INSERT INTO BOARD(BOARD_NO, STATION_NO, USER_NO , TITLE, CONTENT ) VALUES (SEQ_BOARD_NO.NEXTVAL, 402 , 1 , '별내별가람 역에 이상함 사람있음 ㅋㅋ', '[사진]옷 이렇게 입고있는데 본사람?');
INSERT INTO BOARD(BOARD_NO, STATION_NO, USER_NO , TITLE, CONTENT ) VALUES (SEQ_BOARD_NO.NEXTVAL, 432 , 2 , '과천역 화장실', '과천역 남자 화장실 1사로 누가 막고 도망갔어 나와라');
INSERT INTO BOARD(BOARD_NO, STATION_NO, USER_NO , TITLE, CONTENT ) VALUES (SEQ_BOARD_NO.NEXTVAL, 404 , 3 , '상계역에서 핸드폰 잃어버렸어요 ㅠㅠ', '[사진] 이렇게 생겼는데 보신 분 댓글 달아주세요 ㅠㅠㅠㅠㅠㅠㅠ');
INSERT INTO BOARD(BOARD_NO, STATION_NO, USER_NO , TITLE, CONTENT ) VALUES (SEQ_BOARD_NO.NEXTVAL, 405 , 4 , '노원역 지갑주인 찾습니다', '[사진] 이런 지갑 주인분 댓글 달아주시거나 010-1234-5678로 연락주세요~');
INSERT INTO BOARD(BOARD_NO, STATION_NO, USER_NO , TITLE, CONTENT ) VALUES (SEQ_BOARD_NO.NEXTVAL, 406 , 5 , '강남역 조심하세요', '[사진][사진]여기 사건사고 터져서 경찰오고 난리남');

-- BOARD_COMMENT
INSERT INTO BOARD_COMMENT(COMMENT_NO , BOARD_NO , USER_NO ,CONTENT) VALUES (SEQ_COMMENT_NO.NEXTVAL, 1 , 1 , '나도봄 ㅋ');
INSERT INTO BOARD_COMMENT(COMMENT_NO , BOARD_NO , USER_NO ,CONTENT) VALUES (SEQ_COMMENT_NO.NEXTVAL, 1 , 1 , '나도 무슨 왕관쓰고 창들고 다니더라');
INSERT INTO BOARD_COMMENT(COMMENT_NO , BOARD_NO , USER_NO ,CONTENT) VALUES (SEQ_COMMENT_NO.NEXTVAL, 2 , 2 , '아 급똥인데 다른곳은 괜찮나요?');
INSERT INTO BOARD_COMMENT(COMMENT_NO , BOARD_NO , USER_NO ,CONTENT) VALUES (SEQ_COMMENT_NO.NEXTVAL, 2 , 2 , '2번 사로 내가 쓰는중인데 방금 들어왔어요');
INSERT INTO BOARD_COMMENT(COMMENT_NO , BOARD_NO , USER_NO ,CONTENT) VALUES (SEQ_COMMENT_NO.NEXTVAL, 3 , 3 , '그거 벤치에서 봤어요 한 10분전에?');
INSERT INTO BOARD_COMMENT(COMMENT_NO , BOARD_NO , USER_NO ,CONTENT) VALUES (SEQ_COMMENT_NO.NEXTVAL, 3 , 3 , '제가 가지고 있습니다! 핸드폰 배터리가 없는거 같아서 010-2222-3333으로 연락주세요');
INSERT INTO BOARD_COMMENT(COMMENT_NO , BOARD_NO , USER_NO ,CONTENT) VALUES (SEQ_COMMENT_NO.NEXTVAL, 4 , 4 , '제겁니다 연락드릴게요!');
INSERT INTO BOARD_COMMENT(COMMENT_NO , BOARD_NO , USER_NO ,CONTENT) VALUES (SEQ_COMMENT_NO.NEXTVAL, 5 , 5 , '와 살벌하네');
INSERT INTO BOARD_COMMENT(COMMENT_NO , BOARD_NO , USER_NO ,CONTENT) VALUES (SEQ_COMMENT_NO.NEXTVAL, 5 , 5 , '님님 역 카테고리 창동역으로 되있어요 바꿔주세요');

--NOTICE
INSERT INTO NOTICE(NOTICE_NO, STATION_NO, ADMIN_NO, POST_TIME, TITLE, CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_NOTICE_NO.NEXTVAL, 132, '1', '2023-9-27', '1호선 시청역 시위로 인한 열차지연 안내', '1호선 시청역 상행선에서 [전국장애인차별철폐연대]의 시위가 있을 예정입니다. 
이에 따라  해당구간 열차 운행에 상당한 지연이 발생할 수 있으며, 상황에 따라 해당 역을 무정차 통과할 예정이오니 열차 이용에 참고하시기 바랍니다.', '22', 'N');
INSERT INTO NOTICE(NOTICE_NO, STATION_NO, ADMIN_NO, POST_TIME, TITLE, CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_NOTICE_NO.NEXTVAL, 436, '2', '2023-10-07', '4호선 범계역 보수장비 궤도이탈 장애조치 발생 안내', '수도권 4호선 하행 범계역에서 발생한 보수장비 궤도이탈 장애조치가 발생되었습니다. 이로인한 여파로 4호선 일부 열차운행이 지연중입니다. 열차 이용에 참고하시기 바랍니다.', '15', 'N');
INSERT INTO NOTICE(NOTICE_NO, STATION_NO, ADMIN_NO, POST_TIME, TITLE, CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_NOTICE_NO.NEXTVAL, 230, '3', '2023-10-16', '2호선 신대방역 무정차 통과 안내', '2호선 신대방역 인근 도림천 범람 우려로 신대방역 양방향 열차 무정차 통과 중입니다. 이용 고객께서는 열차 이용에 참고하시기 바랍니다', '17', 'N');
INSERT INTO NOTICE(NOTICE_NO, STATION_NO, ADMIN_NO, POST_TIME, TITLE, CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_NOTICE_NO.NEXTVAL, 502, '4', '2023-10-25', '5호선 김포공항역 지하철 화재대응 훈련 실시 (14:00~15:00)', '11월2일(목) 오후 2시부터 5호선 김포공항역에서 2023년도 안전한국훈련 일환으로 지하철 화재대응훈련(14:00~15:00)을 실시합니다. 김포공항 역사가 훈련참여 인원으로 혼잡스러울 수 있으며, 5호선 열차 운행이 정시보다 다소 지연될 수 있습니다. 열차 이용에 참고하세요.', '7', 'N');
INSERT INTO NOTICE(NOTICE_NO, STATION_NO, ADMIN_NO, POST_TIME, TITLE, CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_NOTICE_NO.NEXTVAL, 414, '5', '2023-10-27', '4호선 혜화역 상선(당고개행) 열차 고장 안내', '4호선 혜화역 상선(당고개행) 열차 고장 안내
오늘(10월 27일) 16시 20분경 부터 수도권 4호선 혜화역 상선 열차 고장으로 인하여 당고개행 열차 운행이 지연되고 있음을 안내드리오니, 열차 이용에 참고 부탁드립니다.', '4', 'N');
COMMIT;

--FAQ
INSERT INTO FAQ(FAQ_NO, STATION_NO, ADMIN_NO, POST_TIME, FAQ_TITLE, CONTENT, DELETE_YN) VALUES (SEQ_FAQ_NO.NEXTVAL, 221, '1', '2023-10-02', '역삼역 자전거를 가지고 전철을 탈 수 있나요?', '2호선 전동차의 경우는 일반 고객의 이용 불편과 안전사고 발생 등의 문제로 자전거 휴대승차가 제한되오니 고객님의 양해 바랍니다.
<다만, 유모차, 휠체어 및 접힌 상태의 접이식 자전거는 휴대가 가능합니다.>', 'N');
INSERT INTO FAQ(FAQ_NO, STATION_NO, ADMIN_NO, POST_TIME, FAQ_TITLE, CONTENT, DELETE_YN) VALUES (SEQ_FAQ_NO.NEXTVAL, 517, '2', '2023-10-10', '여의나루역 근처 가장 가장 가까운 주차장의 위치는 어떻게 되나요?', '여의나루역 근처 가까운 주차장 위치는
영등포구 여의도동 86-5 여의도1주차장(63빌딩 앞) , 
영등포구 여의도동 84-4 여의도2주차장(마포대교 남단) 
입니다.', 'N');
INSERT INTO FAQ(FAQ_NO, STATION_NO, ADMIN_NO, POST_TIME, FAQ_TITLE, CONTENT, DELETE_YN) VALUES (SEQ_FAQ_NO.NEXTVAL, 402, '3', '2023-10-17', '별내별가람역 엘리베이터가 있는 출구 번호는 몇 번인가요?', '엘리베이터가 있는 출구는 1번, 2번, 3번 출구 입니다.', 'N');
INSERT INTO FAQ(FAQ_NO, STATION_NO, ADMIN_NO, POST_TIME, FAQ_TITLE, CONTENT, DELETE_YN) VALUES (SEQ_FAQ_NO.NEXTVAL, 502, '4', '2023-10-24', '공항철도 지하철이 운영이 끝나는 시간은 몇시인가요? ', '공항철도 지하철은 일요일, 월요일, 화요일, 수요일, 목요일, 금요일, 토요일 오후 11:38에 운영이 중단됩니다.', 'N');
COMMIT;

-- QNA_ADMIN
INSERT INTO QNA_ADMIN(QNA_ADMIN_NO, STATION_NO, ADMIN_NO, USER_NO, POST_TIME, RE_TITLE, RE_CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_ADMIN_NO.NEXTVAL, 100, '05', '1', SYSDATE, '관리자 답변사항입니다', '고객님이 불편함이 없도록 쓰레기통을 설치할 계획입니다. 감사합니다.', '1', 'N');
INSERT INTO QNA_ADMIN(QNA_ADMIN_NO, STATION_NO, ADMIN_NO, USER_NO, POST_TIME, RE_TITLE, RE_CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_ADMIN_NO.NEXTVAL, 100, '05', '2', SYSDATE, '질의답변입니다.', '역사 내 휴지는 매일 2회씩 교체해주고 있습니다. 시설 이용에 불편을 끼쳐드려 죄송합니다.', '1', 'N');
INSERT INTO QNA_ADMIN(QNA_ADMIN_NO, STATION_NO, ADMIN_NO, USER_NO, POST_TIME, RE_TITLE, RE_CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_ADMIN_NO.NEXTVAL, 100, '05', '3', SYSDATE, '질의답변', '키오스크는 현재 설치가 불가능합니다. 감사합니다.', '1', 'N');
INSERT INTO QNA_ADMIN(QNA_ADMIN_NO, STATION_NO, ADMIN_NO, USER_NO, POST_TIME, RE_TITLE, RE_CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_ADMIN_NO.NEXTVAL, 100, '05', '4', SYSDATE, '질의답변사항', '지금 현재 역사 내 공사가 진행중입니다. 양해 부탁드립니다.', '1', 'N');
INSERT INTO QNA_ADMIN(QNA_ADMIN_NO, STATION_NO, ADMIN_NO, USER_NO, POST_TIME, RE_TITLE, RE_CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_ADMIN_NO.NEXTVAL, 100, '05', '5', SYSDATE, '질의답변사항', 'QNA게시판에서 장난은 사절입니다. 계속된 장난 진행시 형사처벌이 진행될 수 있습니다.', '1', 'N');
COMMIT;

-- QNA
INSERT INTO QNA(QNA_NO, STATION_NO, USER_NO, POST_TIME, TITLE, CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_NO.NEXTVAL, 100, '1' , SYSDATE , '질의사항입니다.', '왜 역 근처에 쓰레기가 많죠? 쓰레기통을 만들 생각은 없으신가요?', '1', 'N');
INSERT INTO QNA(QNA_NO, STATION_NO, USER_NO, POST_TIME, TITLE, CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_NO.NEXTVAL, 100, '2' , SYSDATE , '질의사항이에요', '왜 역 화장실 내 휴지가 없죠? 매일 채워주세요 ㅠ', '1', 'N');
INSERT INTO QNA(QNA_NO, STATION_NO, USER_NO, POST_TIME, TITLE, CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_NO.NEXTVAL, 100, '3' , SYSDATE , '질의사항!!!', '역 근처에 뭔가 키오스크 같은것을 필요로 하는데 설치가 가능한가요?', '1', 'N');
INSERT INTO QNA(QNA_NO, STATION_NO, USER_NO, POST_TIME, TITLE, CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_NO.NEXTVAL, 100, '4' , SYSDATE , '질의사항 봐주세요', '역 근처에 이상한 소음이 너무 많아요. 원인 좀 찾아주세요', '1', 'N');
INSERT INTO QNA(QNA_NO, STATION_NO, USER_NO, POST_TIME, TITLE, CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_NO.NEXTVAL, 100, '5' , SYSDATE , '역사 내 관련 질의사항', '사람 살려주세요!', '1', 'N');
