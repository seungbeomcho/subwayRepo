...
DROP TABLE QNA_ADMIN CASCADE CONSTRAINTS; -- QNA_ADMIN 테이블
...
DROP TABLE BOARD_COMMENT CASCADE CONSTRAINTS; -- BOARD_COMMENT 테이블
-- ----------------------------------------------------
-- 시퀀스 DROP 삭제
-- ----------------------------------------------------
...
DROP SEQUENCE SEQ_COMMENT_NO; -- BOARD_COMMENT 테이블
-- ----------------------------------------------------
-- CREATE 테이블 생성
-- ----------------------------------------------------
-- ADMIN 테이블 (조승범님)
...
COMMENT ON COLUMN BOARD_COMMENT.BOARD_NO IS '게시판번호';
COMMENT ON COLUMN BOARD_COMMENT.USER_NO IS '유저번호';
COMMENT ON COLUMN BOARD_COMMENT.ADMIN_NO IS '관리자번호';
COMMENT ON COLUMN BOARD_COMMENT.CONTENT IS '댓글내용';
COMMENT ON COLUMN BOARD_COMMENT.ENROLL_DATE IS '작성일시';
COMMENT ON COLUMN BOARD_COMMENT.MODIFY_DATE IS '수정일시';
COMMENT ON COLUMN BOARD_COMMENT.DELETE_YN IS '삭제여부';
...
COMMENT ON COLUMN FAQ.INQUIRY IS '조회수';
...
COMMENT ON COLUMN "QNA_ADMIN"."QNA_NO" IS '질의응답번호';
COMMENT ON COLUMN "QNA_ADMIN"."STATION_NO" IS '지하철역번호';
COMMENT ON COLUMN "QNA_ADMIN"."ADMIN_NO" IS '답변관리자번호';
COMMENT ON COLUMN "QNA_ADMIN"."USER_NO" IS '유저번호';
COMMENT ON COLUMN "QNA_ADMIN"."RE_TITLE" IS '답변제목';
COMMENT ON COLUMN "QNA_ADMIN"."RE_CONTENT" IS '답변내용';
COMMENT ON COLUMN "QNA_ADMIN"."INQUIRY" IS '조회수';
COMMENT ON COLUMN "QNA_ADMIN"."POST_TIME" IS '작성일시';
COMMENT ON COLUMN "QNA_ADMIN"."DELETE_YN" IS '삭제여부';
...
CREATE SEQUENCE SEQ_COMMENT_NO NOCYCLE NOCACHE; -- BOARD_COMMENT 시퀀스
-- ----------------------------------------------------
-- 외래키
-- ----------------------------------------------------
-- STATION 환승역 외래키
...
-- QNA_ADMIN 외래키
ALTER TABLE QNA_ADMIN
ADD CONSTRAINT FK_QNA_ADMIN_STATION
FOREIGN KEY(STATION_NO) REFERENCES STATION(STATION_NO);

ALTER TABLE QNA_ADMIN 
ADD CONSTRAINT FK_QNA_AMDIN_ADMIN
FOREIGN KEY(ADMIN_NO) REFERENCES ADMIN(ADMIN_NO);

ALTER TABLE QNA_ADMIN
ADD CONSTRAINT FK_QNA_ADMIN_USER
FOREIGN KEY(USER_NO) REFERENCES SUBWAY_USER(USER_NO);
...
INSERT INTO ADMIN(ADMIN_NO, ID, PWD, NICK, PART_NAME) VALUES (SEQ_ADMIN_NO.NEXTVAL, 'ADMIN06', '1234', 'BOD', 'BOARD');
COMMIT;
...
-- BOARD
INSERT INTO BOARD(BOARD_NO, STATION_NO, USER_NO , TITLE, CONTENT ) VALUES (SEQ_BOARD_NO.NEXTVAL, 402 , 1 , '제목01', '내용01');
INSERT INTO BOARD(BOARD_NO, STATION_NO, USER_NO , TITLE, CONTENT ) VALUES (SEQ_BOARD_NO.NEXTVAL, 432 , 2 , '제목02', '내용02');
INSERT INTO BOARD(BOARD_NO, STATION_NO, USER_NO , TITLE, CONTENT ) VALUES (SEQ_BOARD_NO.NEXTVAL, 404 , 3 , '제목03', '내용03');
INSERT INTO BOARD(BOARD_NO, STATION_NO, USER_NO , TITLE, CONTENT ) VALUES (SEQ_BOARD_NO.NEXTVAL, 405 , 4 , '제목04', '내용04');
INSERT INTO BOARD(BOARD_NO, STATION_NO, USER_NO , TITLE, CONTENT ) VALUES (SEQ_BOARD_NO.NEXTVAL, 406 , 5 , '제목05', '내용05');

-- BOARD_COMMENT
INSERT INTO BOARD_COMMENT(COMMENT_NO , BOARD_NO , USER_NO ,CONTENT) VALUES (SEQ_COMMENT_NO.NEXTVAL, 1 , 1 , '댓글 ㅋㅋ1');
INSERT INTO BOARD_COMMENT(COMMENT_NO , BOARD_NO , USER_NO ,CONTENT) VALUES (SEQ_COMMENT_NO.NEXTVAL, 2 , 2 , '댓글 ㅋㅋ2');
INSERT INTO BOARD_COMMENT(COMMENT_NO , BOARD_NO , USER_NO ,CONTENT) VALUES (SEQ_COMMENT_NO.NEXTVAL, 3 , 3 , '댓글 ㅋㅋ3');
INSERT INTO BOARD_COMMENT(COMMENT_NO , BOARD_NO , USER_NO ,CONTENT) VALUES (SEQ_COMMENT_NO.NEXTVAL, 4 , 4 , '댓글 ㅋㅋ4');
INSERT INTO BOARD_COMMENT(COMMENT_NO , BOARD_NO , USER_NO ,CONTENT) VALUES (SEQ_COMMENT_NO.NEXTVAL, 5 , 5 , '댓글 ㅋㅋ5');

-- NOTICE
INSERT INTO NOTICE(NOTICE_NO, STATION_NO, ADMIN_NO, POST_TIME, TITLE, CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_NOTICE_NO.NEXTVAL, 100, '1', '2023-10-15', '제목01', '내용01', '1', 'N');
INSERT INTO NOTICE(NOTICE_NO, STATION_NO, ADMIN_NO, POST_TIME, TITLE, CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_NOTICE_NO.NEXTVAL, 101, '2', '2023-10-16', '제목02', '내용02', '2', 'N');
INSERT INTO NOTICE(NOTICE_NO, STATION_NO, ADMIN_NO, POST_TIME, TITLE, CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_NOTICE_NO.NEXTVAL, 102, '3', '2023-10-17', '제목03', '내용03', '3', 'N');
INSERT INTO NOTICE(NOTICE_NO, STATION_NO, ADMIN_NO, POST_TIME, TITLE, CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_NOTICE_NO.NEXTVAL, 103, '4', '2023-10-18', '제목04', '내용04', '4', 'N');
INSERT INTO NOTICE(NOTICE_NO, STATION_NO, ADMIN_NO, POST_TIME, TITLE, CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_NOTICE_NO.NEXTVAL, 104, '5', '2023-10-19', '제목05', '내용05', '5', 'N');
COMMIT;
    
-- FAQ
INSERT INTO FAQ(FAQ_NO, STATION_NO, ADMIN_NO, POST_TIME, FAQ_TITLE, CONTENT, DELETE_YN) VALUES (SEQ_FAQ_NO.NEXTVAL, 100, '1', '2023-10-15', 'FAQ01', '내용01', 'N');
INSERT INTO FAQ(FAQ_NO, STATION_NO, ADMIN_NO, POST_TIME, FAQ_TITLE, CONTENT, DELETE_YN) VALUES (SEQ_FAQ_NO.NEXTVAL, 101, '2', '2023-10-16', 'FAQ02', '내용02', 'N');
INSERT INTO FAQ(FAQ_NO, STATION_NO, ADMIN_NO, POST_TIME, FAQ_TITLE, CONTENT, DELETE_YN) VALUES (SEQ_FAQ_NO.NEXTVAL, 102, '3', '2023-10-17', 'FAQ03', '내용03', 'N');
INSERT INTO FAQ(FAQ_NO, STATION_NO, ADMIN_NO, POST_TIME, FAQ_TITLE, CONTENT, DELETE_YN) VALUES (SEQ_FAQ_NO.NEXTVAL, 103, '4', '2023-10-18', 'FAQ04', '내용04', 'N');
INSERT INTO FAQ(FAQ_NO, STATION_NO, ADMIN_NO, POST_TIME, FAQ_TITLE, CONTENT, DELETE_YN) VALUES (SEQ_FAQ_NO.NEXTVAL, 104, '5', '2023-10-19', 'FAQ05', '내용05', 'N');
COMMIT;

-- QNA
INSERT INTO QNA(QNA_NO, STATION_NO, USER_NO, POST_TIME, TITLE, CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_NO.NEXTVAL, 100, '1' , '2023-10-18' , '제목01', '내용01', '1', 'N');
INSERT INTO QNA(QNA_NO, STATION_NO, USER_NO, POST_TIME, TITLE, CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_NO.NEXTVAL, 100, '2' , '2023-10-18' , '제목02', '내용02', '1', 'N');
INSERT INTO QNA(QNA_NO, STATION_NO, USER_NO, POST_TIME, TITLE, CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_NO.NEXTVAL, 100, '3' , '2023-10-18' , '제목03', '내용03', '1', 'N');
INSERT INTO QNA(QNA_NO, STATION_NO, USER_NO, POST_TIME, TITLE, CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_NO.NEXTVAL, 100, '4' , '2023-10-18' , '제목04', '내용04', '1', 'N');
INSERT INTO QNA(QNA_NO, STATION_NO, USER_NO, POST_TIME, TITLE, CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_NO.NEXTVAL, 100, '5' , '2023-10-18' , '제목05', '내용05', '1', 'N');

-- QNA_ADMIN
INSERT INTO QNA_ADMIN(QNA_NO, STATION_NO, ADMIN_NO, USER_NO, POST_TIME, RE_TITLE, RE_CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_NO.NEXTVAL, 100, '05', '1', '2023-10-18', '답변01', '답변내용01', '1', 'N');
INSERT INTO QNA_ADMIN(QNA_NO, STATION_NO, ADMIN_NO, USER_NO, POST_TIME, RE_TITLE, RE_CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_NO.NEXTVAL, 100, '05', '2', '2023-10-18', '답변02', '답변내용02', '1', 'N');
INSERT INTO QNA_ADMIN(QNA_NO, STATION_NO, ADMIN_NO, USER_NO, POST_TIME, RE_TITLE, RE_CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_NO.NEXTVAL, 100, '05', '3', '2023-10-18', '답변03', '답변내용03', '1', 'N');
INSERT INTO QNA_ADMIN(QNA_NO, STATION_NO, ADMIN_NO, USER_NO, POST_TIME, RE_TITLE, RE_CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_NO.NEXTVAL, 100, '05', '4', '2023-10-18', '답변04', '답변내용04', '1', 'N');
INSERT INTO QNA_ADMIN(QNA_NO, STATION_NO, ADMIN_NO, USER_NO, POST_TIME, RE_TITLE, RE_CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_NO.NEXTVAL, 100, '05', '5', '2023-10-18', '답변05', '답변내용05', '1', 'N');
COMMIT;
