...
DROP SEQUENCE SEQ_QNA_ADMIN_NO; -- QNA_ADMIN 테이블
-- ----------------------------------------------------
-- CREATE 테이블 생성
-- ----------------------------------------------------
-- ADMIN 테이블 (조승범님)
...
CREATE TABLE QNA_ADMIN(
    QNA_ADMIN_NO           NUMBER          PRIMARY KEY
    ,STATION_NO      NUMBER
    ,ADMIN_NO        NUMBER         
    ,USER_NO         NUMBER
...
COMMENT ON COLUMN "QNA_ADMIN"."QNA_ADMIN_NO" IS '질의응답번호';
...
CREATE SEQUENCE SEQ_QNA_ADMIN_NO NOCYCLE NOCACHE; -- QNA_ADMIN 시퀀스
-- ----------------------------------------------------
-- 외래키
-- ----------------------------------------------------
-- STATION 환승역 외래키
...
-- QNA_ADMIN
INSERT INTO QNA_ADMIN(QNA_ADMIN_NO, STATION_NO, ADMIN_NO, USER_NO, POST_TIME, RE_TITLE, RE_CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_ADMIN_NO.NEXTVAL, 100, '05', '1', '2023-10-18', '답변01', '답변내용01', '1', 'N');
INSERT INTO QNA_ADMIN(QNA_ADMIN_NO, STATION_NO, ADMIN_NO, USER_NO, POST_TIME, RE_TITLE, RE_CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_ADMIN_NO.NEXTVAL, 100, '05', '1', '2023-10-18', '답변06', '답변내용06', '1', 'N');
INSERT INTO QNA_ADMIN(QNA_ADMIN_NO, STATION_NO, ADMIN_NO, USER_NO, POST_TIME, RE_TITLE, RE_CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_ADMIN_NO.NEXTVAL, 100, '05', '2', '2023-10-18', '답변02', '답변내용02', '1', 'N');
INSERT INTO QNA_ADMIN(QNA_ADMIN_NO, STATION_NO, ADMIN_NO, USER_NO, POST_TIME, RE_TITLE, RE_CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_ADMIN_NO.NEXTVAL, 100, '05', '3', '2023-10-18', '답변03', '답변내용03', '1', 'N');
INSERT INTO QNA_ADMIN(QNA_ADMIN_NO, STATION_NO, ADMIN_NO, USER_NO, POST_TIME, RE_TITLE, RE_CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_ADMIN_NO.NEXTVAL, 100, '05', '4', '2023-10-18', '답변04', '답변내용04', '1', 'N');
INSERT INTO QNA_ADMIN(QNA_ADMIN_NO, STATION_NO, ADMIN_NO, USER_NO, POST_TIME, RE_TITLE, RE_CONTENT, INQUIRY, DELETE_YN) VALUES (SEQ_QNA_ADMIN_NO.NEXTVAL, 100, '05', '5', '2023-10-18', '답변05', '답변내용05', '1', 'N');
COMMIT;
