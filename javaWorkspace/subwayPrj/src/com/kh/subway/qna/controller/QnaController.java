...
public class QnaController {
	...
	private void reTitleCorrect() {
		 ...
		 try {
				...
				if(Main.loginAdmin != null) {
					System.out.print("변경할 관리자 일반 번호 : ");
	...
	public void writeDetailByNo() {
		...
		try {
			...
			System.out.println("작성일자 : " + vo.getRePostTime());
			System.out.println("------------------------------");
